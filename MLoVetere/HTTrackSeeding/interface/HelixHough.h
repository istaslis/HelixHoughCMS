...
class HelixHough
{
  public:
    ...
    //quantities for debugging
    std::vector<std::vector<int> > hitsinzoomlevel;
    std::vector<int> clustersinzoomlevel_phi;
    std::vector<int> clustersinzoomlevel_d;
    std::vector<int> clustersinzoomlevel_k;
    std::vector<int> clustersinzoomlevel_dzdl;
    std::vector<int> clustersinzoomlevel_z0;
  ...
  protected:
    ...
    double z_vote_time;
    double cluster_time;
    double votesort_time;
    
    bool print_timings;
    
    bool separate_by_helicity,only_one_helicity,helicity;
